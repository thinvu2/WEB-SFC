...
namespace SN_API.Controllers
{
    ...
    public class Config6Controller : ApiController
    {
        ...
        public async Task<HttpResponseMessage> Config6GetAllModelSerial(string database_name)
        {
            string strGetData = "select DISTINCT MODEL_SERIAL from SFIS1.C_MODEL_DESC_T where MODEL_SERIAL not like '10.%'";
