    ...
    public class QASN_INController : ApiController
    {
        ...
        public async Task<HttpResponseMessage> GetShowDetail(string database_name, string PACKSLIP_NO, string FLAG, string F_ID)
        {
            try
            {
                ...
                strGetData = $@"select PACKSLIP_NO, FLAG, F_ID, SHIP_MCMN_CREATTIME, MSG_SENDER_NAME, MSG_RECEIVER_NAME, AIRWAYBILL, FREIGHT_CARRIER_CODE,SUPPLIER_NAME, SHIP_MCMN_LOCATIONNAME,
                ...
                strGetDataTableOuterLPN = $"SELECT F_ID, LOT_NO,OUTERBOX_LPN,INNERBOX_LPN,INNERBOX_SHIPPEDQTY FROM SFISM4.R_QASN_IN WHERE PACKSLIP_NO='1400606060' ORDER BY F_ID desc";
