...
export default createStore({
    state: {
       ...
       apiAddress: "http://10.220.15.158/API",
        ...
        isShowQMModel: false,
        isShowModalConfig7: false,
        isShowQMMO: false,
        isShowQMLine: false,
        isShowQMGroup: false,
        isShowConfig43: false,
        ...
        listSelectDualModel: [],
        listSelectDualModelConfig7: [],
        listAvaiDualModel: [],
        listAvaiDualModelConfig7: [],
        listSelectDualMO: [],
        listAvaiDualMO: [],
        listSelectDualLine: [],
        listAvaiDualLine: [],
        listSelectDualGroup: [],
        listSelectDualConfig43: [],
        listAvaiDualGroup: [],
        listAvaiDualConfig43: [],
        listLock: [],
        dateTimeFromQM: '',
        dateTimeToQM: '',
        listAvaiDualModelSearch: [],
        listAvaiDualModelSearchConfig7: [],
        listAvaiDualMOSearch: [],
        listAvaiDualLineSearch: [],
        listAvaiDualGroupSearch: [],
        listAvaiDualGroupSearchConfig43: [],
        lock_emp_pass: '',
        lock_model_name: '',
        lock_group_name: '',
        lock_type: '',
