        ...
        if (typeof this.dataCheckPrivilege != "undefined") {
          if (this.dataCheckPrivilege.length != 0) {
            if (element.Name != "") {
              ...
              if(element.ReplaceName == "CONFIG_NIC3S" || element.ReplaceName == "CONFIG_NICLSSC"
              || element.Name == "PASSWORD" || element.Name == "CHECK_LOG"){            
                element.IsDisable = 0;
              }
      ...
      if (typeof this.dataList != "undefined") {
        if (this.dataList.length != 0) {
          this.dataList1.forEach((element) => {
            ...
            if(element.Name == "CONFIG_NIC3S" || element.Name == "CONFIG_LSSC" || element.Name == "CONFIG_PO" 
            || element.Name == "PASSWORD" || element.Name == "CHECK_LOG" || element.Name == "MODEL_ATTRCONFIG"){            
              element.IsDisable = 1;              
            } 
          });
        }
