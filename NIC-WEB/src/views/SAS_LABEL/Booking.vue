  ...
  <div class="div-all">
    ...
    <div class="div-searchbox row">
      <div class="div-searchbox-content">
        <input
          ...
          @click="selectAll"
          :placeholder="
            $store.state.language == 'En' ? 'Enter NAME...' : 'Nhập tên NAME...'
          "
        />
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">LIST_MODELNAME</label>
          <input
            class="form-control text-element"
            :value="model.LIST_MODELNAME"
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">DEFAULT_STEP</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.DEFAULT_STEP"
            @input="updateCONTROL_TIME"
            textPlaceHolder="Enter CONTROL_TIME"
          />
        </div>
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">START</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.START"
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">END</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.END"
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">LAST</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.LAST"
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">QTY</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.QTY"
        ...
        <div class="col-md-3 mb-3">
          <label for="CONTROL_TIME">LEFT QTY</label>
          <input
            class="form-control text-element"
            id="CONTROL_TIME"
            :value="model.LEFT_QTY"
            @input="updateCONTROL_TIME"
            textPlaceHolder="Enter CONTROL_TIME"
          />
        </div>
